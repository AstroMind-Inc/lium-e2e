...
test.describe('User API', () => {
  ...
  test('GET /users should return user list', async ({ authenticatedContext, validator }) => {
  ...
  test('GET /users/:id should return single user', async ({ authenticatedContext, validator }) => {
  ...
  test('GET /users with pagination should work', async ({ authenticatedContext }) => {
  ...
  test('POST /users should create new user', async ({ authenticatedContext, validator }) => {
    const newUser = {
  ...
  test('PUT /users/:id should update user', async ({ authenticatedContext }) => {
  ...
  test('DELETE /users/:id should delete user', async ({ authenticatedContext }) => {
...
test.describe('User API - Error Handling', () => {
  test('GET /users/:id with invalid ID should return 404', async ({ authenticatedContext }) => {
  ...
  test('POST /users without authentication should return 401', async ({ apiContext }) => {
    const newUser = {
      email: 'test@lium.com',
      name: 'Test User',
    };
  ...
  test('POST /users with invalid data should return 400', async ({ authenticatedContext }) => {
    const invalidUser = {
...
test.describe('User API - Performance', () => {
  test('GET /users should respond quickly', async ({ authenticatedContext, envConfig }) => {
