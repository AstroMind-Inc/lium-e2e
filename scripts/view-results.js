...
function calculateStats(results) {
  ...
  return { total, passed, failed, skipped, avgDuration, passRate: (passed / total * 100).toFixed(1) };
}
...
if (command === 'trends') {
  ...
  if (!testName) {
    console.log('Usage: node view-results.js trends <pillar> <environment> <testName>\n');
    process.exit(1);
  }
